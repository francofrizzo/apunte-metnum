...
$(x_0,f(x_0)), \dots, (x_n,f(x_n))$, encontrar una función $I$ tal que
$\fall{0 \leq i \leq n} I(x_i) = f(x_i)$. Este problema tiene múltiples
aplicaciones; resulta útil, por ejemplo:
\begin{itemize}
